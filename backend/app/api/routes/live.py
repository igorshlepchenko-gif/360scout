...
# 2026-08-17: sole display filter now. A combined confidence>=80% + odds test
# ran 2026-08-03–17 and never passed a single live match at either odds floor
# tried (1.60, then 1.40) — the confidence filter was removed as a result.
# Rollback tag if needed: pre-confidence-odds-filter-2026-08-03.
